...
class TableList extends \WP_List_Table {
	...
	public function get_columns() {
		...
		$posts_columns = apply_filters( "translationmanager_manage_{$this->screen->id}_columns", $posts_columns );
	...
	protected function handle_row_actions( $item, $column_name, $primary ) {
		...
		return $this->row_actions( apply_filters( "translationmanager_{$this->screen->id}_row_actions", [], $item ) );
	}
}
