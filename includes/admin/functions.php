...
class InpsydeCustomFunctions {
					...
					<div class="welcometxt">
						...
						<table class="eurotext-table">
							<tbody>
								<tr>
									<td class="lefttd">
										<a href="https://eurotext.de/" class="eurotext_logo_translationmanager" title="Eurotext AG"><img src="<?php echo plugins_url( '../../public/img/Eurotext_AG_72dpi_250.png', __FILE__ ) ?>"></a>
									</td>
									<td class="righttd">
										Eurotext AG</br>
										Schürerstraße 3</br>
	...
	public function translationmanager_project_info_save() {
		...
		$term = get_term_by( 'slug', $_POST['_translationmanager_project_id'], TRANSLATIONMANAGER_TAX_PROJECT );

		$update = wp_update_term( $term->term_id, TRANSLATIONMANAGER_TAX_PROJECT, array(
			'name'          => $_POST['tag-name'],
