...
<table class="eurotext-table">
	...
	<tr>
		<td class="lefttd">
			<a href="https://eurotext.de/" class="eurotext-logo-translationmanager" title="Eurotext AG">
				<img src="<?php echo esc_url( $this->plugin->url( '/resources/img/Eurotext_AG_72dpi_250.png' ) ) ?>"/>
			</a>
		</td>
		<td class="righttd">
			Eurotext AG</br>
	...
	<tr>
		<td class="lefttd">
			<a href="https://eurotext-ecommerce.com/translationmanager-dokumentation-support/" class="eurotext-support">
		...
		<td class="righttd">
			...
			<?php esc_html_e( 'Web:', 'translationmanager' ); ?>
			<a href="http://www.eurotext.de/en/">www.eurotext.de/en/</a>
		</td>
	</tr>
	</tbody>
</table>
