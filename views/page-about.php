			...
			<div class="welcometxt">
				<div class="backwpup-welcome">
					<img class="backwpup-banner-img"
					     src="<?php echo esc_url( $this->plugin->url( '/resources/img/Workflow_Industrie_EN.jpg' ) ) ?>"/>
				...
				<table class="eurotext-table">
						...
						<td class="lefttd">
							<a href="https://eurotext.de/" class="eurotext_logo_translationmanager"
							   title="Eurotext AG"><img
									src="<?php echo esc_url( $this->plugin->url( '/resources/img/Eurotext_AG_72dpi_250.png' ) ) ?>"></a>
						</td>
						<td class="righttd">
							Eurotext AG</br>
							Schürerstraße 3</br>
					...
					<tr>
						...
						<td class="righttd">
							<?php esc_html_e( 'Phone:', 'translationmanager' ); ?>+49 (0)931 35 40 50</br>
							<?php esc_html_e( 'Telefax:', 'translationmanager' ); ?>+49 (0)931 35 40 580<br/>
							<?php esc_html_e( 'Email:', 'translationmanager' ); ?><a href="mailto:info@eurotext.de">info@eurotext.de</a><br/>
							<?php esc_html_e( 'Web:', 'translationmanager' ); ?><a href="http://www.eurotext.de/en/">www.eurotext.de/en/</a>
						</td>
					</tr>
					</tbody>
				</table>
